...
def import_csv(file, model_name, *args, **kwargs):
    try:
        with open(
        ...
        print('Невозможно переместить данные')
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        import_csv('static/data/users.csv', User)
        import_csv('static/data/category.csv', Category)
        import_csv('static/data/comments.csv', Comments)
        import_csv('static/data/genre_title.csv', GenreTitle)
        import_csv('static/data/genre.csv', Genre)
        import_csv('static/data/review.csv', Review)
        import_csv('static/data/titles.csv', Title)
